...
def load_images(card_images):
    ...
    for suit in suits:
        for card in range(1, 11):
            name = '{}\cards\{}_{}.{}'.format(cwd ,str(card), suit, extension)
...
def deal_player():
    global block
    if score_hand(player_hand) >= 21 or score_hand(dealer_hand) >= 21 or block:
        pass
    else:
...
dealer_button = tkinter.Button(button_frame, text="Stand", command=deal_dealer)
